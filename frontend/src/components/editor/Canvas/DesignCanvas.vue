      ...
      <div class="absolute inset-0">
        ...
        >
          ...
          <div v-if="showRulers" class="absolute -top-6 -left-6 right-0 bottom-0 pointer-events-none">
            <!-- Horizontal ruler -->
            <div class="absolute top-0 left-6 right-0 h-6 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-600">
              <div class="relative h-full">
                <div
                  v-for="mark in horizontalMarks"
                  :key="mark.position"
                  class="absolute top-0 border-l border-gray-400 dark:border-gray-500"
            ...
            <!-- Vertical ruler -->
            <div class="absolute top-6 left-0 bottom-0 w-6 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-600">
              <div class="relative w-full h-full">
                <div
                  v-for="mark in verticalMarks"
                  :key="mark.position"
                  class="absolute left-0 border-t border-gray-400 dark:border-gray-500"
