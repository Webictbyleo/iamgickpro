<template>
  <div class="flex flex-col h-full bg-gray-50 dark:bg-gray-800">
    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
      <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Browse photos, icons, and shapes</p>
    </div>
      ...
      <div class="space-y-3">
        ...
        <div class="relative">
          <input
            ...
            class="w-full pl-10 pr-10 py-3 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 bg-gray-50 dark:bg-gray-700 focus:bg-white dark:focus:bg-gray-600 text-gray-900 dark:text-gray-100"
