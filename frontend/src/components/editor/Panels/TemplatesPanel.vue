      ...
      <div class="space-y-3">
        ...
        <div v-if="categories.length >= 2" class="relative">
          <select
            ...
            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div v-else class="p-4 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          >
            <div class="relative aspect-video bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden mb-2 hover:shadow-lg transition-all duration-200 border border-gray-200 dark:border-gray-600 hover:border-primary-300 dark:hover:border-primary-400 transform hover:scale-[1.02]">
              <img
