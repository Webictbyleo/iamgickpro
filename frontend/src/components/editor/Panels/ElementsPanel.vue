<template>
  <div class="h-full flex flex-col bg-white">
    ...
    <div class="flex-1 overflow-y-auto">
      <!-- Color Mode View -->
      <div v-if="isColorMode" class="h-full">
        <QuickColorPicker 
          :full-view="true"
          @apply-color="handleApplyColor" 
          @exit-color-mode="handleExitColorMode"
        />
      </div>

      <!-- Normal Elements View -->
      <div v-else>
        <!-- Quick Add Section -->
        <div class="p-4">
        ...
        <div class="p-4 border-t">
          <QuickColorPicker 
            @apply-color="handleApplyColor" 
            @enter-color-mode="handleEnterColorMode"
          />
        </div>
      </div>
    </div>
...
import QuickColorPicker from './QuickColorPicker.vue'
import {
  DocumentTextIcon,
  PhotoIcon,
  Square3Stack3DIcon,
