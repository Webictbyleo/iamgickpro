  ...
  <div class="h-full flex flex-col bg-white dark:bg-gray-900">
    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
      <div class="flex items-center space-x-3">
        ...
        <div>
          <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Image Effects</h3>
          <p class="text-xs text-gray-600 dark:text-gray-400">Transform your images with professional filters</p>
        </div>
      </div>
    </div>
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
      <button
        @click="resetToDefaults"
        class="w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-primary-400 dark:focus:ring-offset-gray-800 transition-colors"
      >
        <ArrowPathIcon class="w-4 h-4 mr-2" />
        Reset All to Defaults
      </button>
      <p class="text-xs text-gray-500 dark:text-gray-400 mt-2 text-center">All changes apply in real-time</p>
    </div>
  </div>
</template>
