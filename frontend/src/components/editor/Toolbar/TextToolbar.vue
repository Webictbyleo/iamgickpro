<template>
  <div class="flex items-center space-x-4">
    ...
    <div class="relative">
      ...
      <div v-if="showAdvancedControls" class="absolute top-full left-0 mt-1 p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-lg z-10 min-w-48">
        <div class="space-y-3">
          <!-- Line Height -->
          <div>
            <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Line Height:</label>
            <div class="flex items-center space-x-2">
              <PropertySlider
          ...
          <!-- Letter Spacing -->
          <div>
            <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Letter Spacing:</label>
            <div class="flex items-center space-x-2">
              <PropertySlider
