<template>
  <div class="flex items-center space-x-4">
    ...
    <div class="flex items-center space-x-2">
      <label class="text-sm font-medium text-gray-700 dark:text-gray-300 min-w-max">Shape:</label>
      <span class="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 rounded-md border border-gray-300 dark:border-gray-600 min-w-[100px] text-gray-900 dark:text-gray-100 font-medium">
    ...
    <!-- Fill Color -->
    <div class="flex items-center space-x-2">
      <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Fill:</label>
      <PropertyColorPicker
    ...
    <!-- Stroke Color -->
    <div class="flex items-center space-x-2">
      <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Stroke:</label>
      <PropertyColorPicker
